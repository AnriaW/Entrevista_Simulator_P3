        ...
        <div className="m-0 p-0 h-full w-full bg-[#16192B] flex flex-col overflow-auto">
            ...
            <div className="w-full h-[90%] flex flex-col items-center justify-center mt-5 mb-[60px] pt-[15px]">
                ...
                <div className="w-[80%] h-full flex flex-row justify-center mt-5">
                    ...
                    <div className="w-[40%] h-full flex flex-col items-start justify-center mr-[25px]">
                        <a className="w-full h-[300px] bg-green-300 border-transparent rounded-[25px] flex items-center justify-center" href="/menu/game/5_softSkills">
                            <img
                                src="/1436714.png"
                    ...
                    {/* Bloco 2 */}
                    <div className="w-[40%] h-full flex flex-col items-start justify-center mr-[25px]">
                        <a className="w-full h-[300px] bg-green-300 border-transparent rounded-[25px] flex items-center justify-center" href="/menu/game/4_gameHard">
                            <img
            ...
            <div className="w-full h-[90%] flex flex-col items-center justify-center mt-5 mb-[60px] pt-[15px]">
                ...
                <div className="w-[80%] h-full flex flex-row justify-center mt-5">
                    {/* Bloco 1 */}
                    <div className="w-[40%] h-full flex flex-col items-start justify-center mr-[25px]">
                        <a className="w-full h-[300px] bg-blue-300 border-transparent rounded-[25px]" href="/">
                            {/* Você pode adicionar uma imagem aqui, se necessário */}
                        </a>
                        <div className="text-white text-[26px] mt-[10px] ml-[10px]">Quais as roupas adequadas para utilizar numa entrevista de emprego?</div>
                    </div>
